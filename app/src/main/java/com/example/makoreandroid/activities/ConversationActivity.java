...
public class ConversationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        messages.add(new Message("hi", "20:40", true));
        messages.add(new Message("friend", "20:42", true));
        messages.add(new Message("hi", "20:43", true));
        messages.add(new Message("friend", "20:44", true));
        messages.add(new Message("hi", "20:45", true));
        messages.add(new Message("friend", "20:46", true));
        messages.add(new Message("hi", "20:40", true));
        messages.add(new Message("friend", "20:42", true));
        ...
        btnSend.setOnClickListener(view->{
            ...
            messages.add(new Message(et.getText().toString(),"21:40",true));
            et.setText("");
            lstMessages.setAdapter(adapter);
            lstMessages.scrollToPosition(messages.size() - 1);
        });
